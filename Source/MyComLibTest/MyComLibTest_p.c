...
#define PROC_FORMAT_STRING_SIZE   317                               
#define EXPR_FORMAT_STRING_SIZE   1                                 
#define TRANSMIT_AS_TABLE_SIZE    0            
#define WIRE_MARSHAL_TABLE_SIZE   2            

typedef struct _MyComLibTest_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } MyComLibTest_MIDL_TYPE_FORMAT_STRING;

typedef struct _MyComLibTest_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } MyComLibTest_MIDL_PROC_FORMAT_STRING;

typedef struct _MyComLibTest_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } MyComLibTest_MIDL_EXPR_FORMAT_STRING;
...
extern const MyComLibTest_MIDL_TYPE_FORMAT_STRING MyComLibTest__MIDL_TypeFormatString;
extern const MyComLibTest_MIDL_PROC_FORMAT_STRING MyComLibTest__MIDL_ProcFormatString;
extern const MyComLibTest_MIDL_EXPR_FORMAT_STRING MyComLibTest__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO ITestATLClass_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ITestATLClass_ProxyInfo;
...
static const MyComLibTest_MIDL_PROC_FORMAT_STRING MyComLibTest__MIDL_ProcFormatString =
    {
        0,
        {
...
static const MyComLibTest_MIDL_TYPE_FORMAT_STRING MyComLibTest__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: ITestATLClass, ver. 0.0,
   GUID={0x572271a0,0x5bce,0x4afd,{0xa5,0xdd,0xd2,0x09,0x4d,0xcc,0x70,0xc6}} */

#pragma code_seg(".orpc")
static const unsigned short ITestATLClass_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SYNTAX_INFO IComponentRegistrar_SyntaxInfo [  2 ] = 
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    MyComLibTest__MIDL_ProcFormatString.Format,
    &IComponentRegistrar_FormatStringOffsetTable[-3],
    MyComLibTest__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    }
...
#pragma code_seg(".orpc")
static const FormatInfoRef ITestATLClass_Ndr64ProcTable[] =
    {
    (FormatInfoRef)(LONG_PTR) -1,
    (FormatInfoRef)(LONG_PTR) -1,
    (FormatInfoRef)(LONG_PTR) -1,
...
static const MIDL_SYNTAX_INFO ITestATLClass_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    MyComLibTest__MIDL_ProcFormatString.Format,
    &ITestATLClass_FormatStringOffsetTable[-3],
    MyComLibTest__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    ...
    0,
    0 ,
    (unsigned short *) &ITestATLClass_Ndr64ProcTable[-3],
    0,
    NDR64_UserMarshalRoutines,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO ITestATLClass_ProxyInfo =
    {
    &Object_StubDesc,
    MyComLibTest__MIDL_ProcFormatString.Format,
    &ITestATLClass_FormatStringOffsetTable[-3],
    (RPC_SYNTAX_IDENTIFIER*)&_RpcTransferSyntax,
    2,
    (MIDL_SYNTAX_INFO*)ITestATLClass_SyntaxInfo
    
    };


static const MIDL_SERVER_INFO ITestATLClass_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    MyComLibTest__MIDL_ProcFormatString.Format,
    (unsigned short *) &ITestATLClass_FormatStringOffsetTable[-3],
    0,
    (RPC_SYNTAX_IDENTIFIER*)&_NDR64_RpcTransferSyntax,
    2,
    (MIDL_SYNTAX_INFO*)ITestATLClass_SyntaxInfo
    };
CINTERFACE_PROXY_VTABLE(9) _ITestATLClassProxyVtbl = 
{
    &ITestATLClass_ProxyInfo,
    &IID_ITestATLClass,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ITestATLClass::AddMethod */ ,
    (void *) (INT_PTR) -1 /* ITestATLClass::AddAndRet */
};


static const PRPC_STUB_FUNCTION ITestATLClass_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ITestATLClassStubVtbl =
{
    &IID_ITestATLClass,
    &ITestATLClass_ServerInfo,
    9,
    &ITestATLClass_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
const CInterfaceProxyVtbl * const _MyComLibTest_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ITestATLClassProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _MyComLibTest_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ITestATLClassStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _MyComLibTest_InterfaceNamesList[] = 
{
    "ITestATLClass",
    "IComponentRegistrar",
    0
...
const IID *  const _MyComLibTest_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _MyComLibTest_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _MyComLibTest, pIID, n)

int __stdcall _MyComLibTest_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _MyComLibTest, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _MyComLibTest, 2, *pIndex )
    
}

const ExtendedProxyFileInfo MyComLibTest_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _MyComLibTest_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _MyComLibTest_StubVtblList,
    (const PCInterfaceName * ) & _MyComLibTest_InterfaceNamesList,
    (const IID ** ) & _MyComLibTest_BaseIIDList,
    & _MyComLibTest_IID_Lookup, 
    2,
    2,
