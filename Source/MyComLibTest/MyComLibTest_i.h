...
#ifndef __MyComLibTest_i_h__
#define __MyComLibTest_i_h__
...
#ifndef __ITestATLClass_FWD_DEFINED__
#define __ITestATLClass_FWD_DEFINED__
typedef interface ITestATLClass ITestATLClass;

#endif 	/* __ITestATLClass_FWD_DEFINED__ */
...
#ifndef __TestATLClass_FWD_DEFINED__
#define __TestATLClass_FWD_DEFINED__

#ifdef __cplusplus
typedef class TestATLClass TestATLClass;
#else
typedef struct TestATLClass TestATLClass;
#endif /* __cplusplus */

#endif 	/* __TestATLClass_FWD_DEFINED__ */
...
#ifndef __ITestATLClass_INTERFACE_DEFINED__
#define __ITestATLClass_INTERFACE_DEFINED__

/* interface ITestATLClass */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_ITestATLClass;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("572271a0-5bce-4afd-a5dd-d2094dcc70c6")
    ITestATLClass : public IDispatch
    {
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE AddAndRet( 
            LONG a,
            LONG b,
            /* [retval][out] */ LONG *rt) = 0;
    ...
    typedef struct ITestATLClassVtbl
    {
        BEGIN_INTERFACE
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *AddAndRet )( 
            ITestATLClass * This,
            LONG a,
            LONG b,
            /* [retval][out] */ LONG *rt);
    ...
    interface ITestATLClass
    {
        CONST_VTBL struct ITestATLClassVtbl *lpVtbl;
    };
...
#define ITestATLClass_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ITestATLClass_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ITestATLClass_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ITestATLClass_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define ITestATLClass_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define ITestATLClass_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define ITestATLClass_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define ITestATLClass_AddMethod(This,a,b)	\
    ( (This)->lpVtbl -> AddMethod(This,a,b) ) 

#define ITestATLClass_AddAndRet(This,a,b,rt)	\
    ( (This)->lpVtbl -> AddAndRet(This,a,b,rt) ) 
...
#endif 	/* __ITestATLClass_INTERFACE_DEFINED__ */



#ifndef __MyComLibTestLib_LIBRARY_DEFINED__
#define __MyComLibTestLib_LIBRARY_DEFINED__

/* library MyComLibTestLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_MyComLibTestLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("d0b9e1c2-b341-4f46-80ee-ebd9e4ad4e19")
CompReg;
#endif

EXTERN_C const CLSID CLSID_TestATLClass;

#ifdef __cplusplus

class DECLSPEC_UUID("da83ddea-a273-4147-89f9-1eb9af7050a1")
TestATLClass;
#endif
#endif /* __MyComLibTestLib_LIBRARY_DEFINED__ */
